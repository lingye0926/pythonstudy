...
# 图片名称
img = '/Users/lye/Documents/programming/automate-the-boring-stuff-with-python/daily.jpeg'  # 图片模板
new_img = 'daily1.jpeg'  # 生成的图片
compress_img = 'daily2.jpeg'  # 压缩后的图片


# 设置字体样式
font_type = r'/System/Library/Fonts/STHeiti Light.ttc'
font_medium_type = r'/System/Library/Fonts/STHeiti Light.ttc'
...
#初始化
bot = Bot()
myfriends = bot.friends().search(u'西瓜太圆')[0]
